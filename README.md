...
Оставшийся технический бэклог (Блоки 2–11): GD-оптимизация изображений и
AssetCollector, файловый кэш, SEO (og-теги, sitemap.xml, robots.txt),
дизайн-система (spacing/анимации/шрифты/тёмная тема), SMTP-клиент и очередь
почты, CLI-миграции, soft-deletes, бэкапы, honeypot, режим обслуживания,
типограф, ACL-роли, веб-инсталлятор, аудит, автопубликация в соцсети.
